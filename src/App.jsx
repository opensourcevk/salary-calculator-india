              ...
              <div className="col-12 col-lg-5">
                <div className="card border-0 bg-primary text-white shadow-sm h-100">
                  <div className="card-body p-4">
                    <p className="text-uppercase small mb-2 text-white-50">Monthly In-Hand Salary</p>
                    <h2 className="display-5 fw-bold">{formatCurrency(summary.monthlyInHand)}</h2>
                    <ul className="list-group list-group-flush mt-4">
                      <li className="list-group-item d-flex justify-content-between bg-transparent text-white px-0">
